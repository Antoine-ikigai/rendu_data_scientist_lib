...
#hundle.min_by(&:length)

#shortest_handle = list.sort_by(&:length).first

#shortest_word = hundle.min_by(&:length)
#puts shortest_word
...
word_count = hundle.count { |word| word.length == 6 }
puts word_count
...
#position = hundle.index("@epenser")
#puts position

#réponse question 7 :373
